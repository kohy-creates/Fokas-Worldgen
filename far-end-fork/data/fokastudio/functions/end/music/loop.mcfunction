execute unless score foka.config foka.config.custom_music matches 1 as @a[predicate=fokastudio:end/locations/in_the_end,tag=!foka.dragon_music,predicate=!fokastudio:end/music/in_end_music_biomes] run stopsound @s music music.end
execute if score foka.config foka.config.custom_music matches 1 as @a[predicate=fokastudio:end/locations/in_the_end,tag=!foka.dragon_music] run stopsound @s music music.end
