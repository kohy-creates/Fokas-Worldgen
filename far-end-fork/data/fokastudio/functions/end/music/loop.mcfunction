execute as @a[predicate=fokastudio:fsee/locations/in_the_end,tag=!foka.dragon_music] unless predicate fokastudio:fsee/music/in_end_music_biomes run stopsound @s music music.end
